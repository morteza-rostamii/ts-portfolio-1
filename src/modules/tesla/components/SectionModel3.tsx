...
const SectionModel3 = () => {
  ...
  const [activeImg, setActiveImg] = useState('/tesla/1/tdbyegwl6nzchqza5jkh.avif');

  useEffect(() => {
    if (width >= 640) {
      setActiveImg('/tesla/1/xufyfcvqhmq36szytod7.avif');
    }
    else {
      setActiveImg('/tesla/1/tdbyegwl6nzchqza5jkh.avif');
    }
  }, [width]);
