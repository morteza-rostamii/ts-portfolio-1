...
const SectionModelX = () => {
  ...
  const [activeImg, setActiveImg] = useState('/tesla/3/Homepage-Model-X-Mobile-LHD_001.avif');

  useEffect(() => {
    if (width >= 640) {
      setActiveImg('/tesla/3/Homepage-Model-X-Desktop-LHD1.avif');
    }
    else {
      setActiveImg('/tesla/3/Homepage-Model-X-Mobile-LHD_001.avif');
    }
  }, [width]);
